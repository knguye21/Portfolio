    ...
    return (
        <div className="h-full w-full p-4 sm:p-10 space-y-9">
            <h1 className="font-fraunces text-1.5xl text-neutral-400 sm:text-2xl lg:text-3xl items-center !leading-tight">
                ...
                <img src='/gallery/headshot.png' alt='headshot' className='inline mx-2 rounded-full object-cover sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-10 xl:h-10' />
                Welcome to my playground
                <img src='/icons/playground.png' alt='playground' className="inline mx-2 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-10 xl:h-10" />
            ...
            <h1 className="font-fraunces text-1.5xl text-neutral-400 sm:text-2xl lg:text-3xl items-center !leading-tight">
                ...
                <img src='/icons/heart.png' alt='heart' className="inline mx-2 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-10 xl:h-10" />
                and &nbsp;
            ...
            <h1 className="font-fraunces text-1.5xl text-neutral-400 sm:text-2xl lg:text-3xl items-center !leading-tight">
                ...
                <img src='/icons/crocheting.png' alt='crocheting' className="inline mx-2 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-10 xl:h-10" />
